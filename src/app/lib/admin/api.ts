...
export const API_BASE = (process.env.NEXT_PUBLIC_API_URL || "https://portfolio-web-gsr.onrender.com");
...
export const adminApi = {
  ...
  upload: {
    resume: async (file: File) => {
      ...
      const res = await fetch(`http://localhost:5000/api/admin/upload/resume`, {
        method: 'POST',
