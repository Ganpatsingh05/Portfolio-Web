...
const skills: Skill[] = [
  { name: 'React/Next.js', level: 90, category: 'frontend', icon: <FaReact className="text-blue-500" /> },
  { name: 'TypeScript', level: 85, category: 'frontend', icon: <SiTypescript className="text-blue-600" /> },
  { name: 'TailwindCSS', level: 88, category: 'frontend', icon: <SiTailwindcss className="text-cyan-500" /> },
  { name: 'JavaScript', level: 92, category: 'frontend', icon: <SiJavascript className="text-yellow-500" /> },
  { name: 'Node.js', level: 80, category: 'backend', icon: <FaNodeJs className="text-green-500" /> },
  { name: 'Python', level: 85, category: 'backend', icon: <FaPython className="text-blue-400" /> },
  { name: 'PostgreSQL', level: 75, category: 'backend', icon: <SiPostgresql className="text-blue-600" /> },
  { name: 'MongoDB', level: 78, category: 'backend', icon: <SiMongodb className="text-green-500" /> },
  { name: 'Git/GitHub', level: 90, category: 'tools', icon: <FaGitAlt className="text-orange-500" /> },
  { name: 'Docker', level: 70, category: 'tools', icon: <FaDocker className="text-blue-500" /> },
  { name: 'AWS', level: 65, category: 'tools', icon: <FaAws className="text-orange-400" /> },
  { name: 'Machine Learning', level: 75, category: 'ai-ml', icon: <FaBrain className="text-purple-500" /> },
  { name: 'TensorFlow', level: 70, category: 'ai-ml', icon: <SiTensorflow className="text-orange-500" /> },
  { name: 'Data Analysis', level: 80, category: 'ai-ml', icon: <FaDatabase className="text-indigo-500" /> }
]
