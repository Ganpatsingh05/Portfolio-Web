    ...
    <footer className="bg-gray-900 dark:bg-black text-white py-12 px-4">
      <div className="max-w-md mx-auto">
        ...
        >
          ...
          <div>
            <motion.div 
              className="mb-4 flex justify-center items-center gap-3 group cursor-pointer"
            ...
            >
              ...
              >
                <img 
                  src="/gslogo.png" 
                  alt="GS Logo"
                  className="h-16 w-auto transition-all duration-300 group-hover:drop-shadow-[0_0_15px_rgba(251,146,60,0.6)]"
                />
                ...
                >
                  <div className="absolute w-2 h-2 bg-orange-400 rounded-full -top-1 left-1/2 transform -translate-x-1/2" />
                  <div className="absolute w-2 h-2 bg-yellow-400 rounded-full top-1/2 -right-1 transform -translate-y-1/2" />
                  <div className="absolute w-2 h-2 bg-orange-300 rounded-full -bottom-1 left-1/2 transform -translate-x-1/2" />
                  <div className="absolute w-2 h-2 bg-yellow-300 rounded-full top-1/2 -left-1 transform -translate-y-1/2" />
                </motion.div>
              </motion.div>
              <motion.h3 
                className="text-2xl font-bold text-white bg-gradient-to-r from-orange-400 to-yellow-500 bg-clip-text text-transparent"
                whileHover={{ 
                  scale: 1.05,
            ...
            <p className="text-gray-300 dark:text-gray-400 text-sm leading-relaxed">
              ...
              and exploring the latest in AI and web technologies.
            </p>
          </div>
          ...
          <div className="text-center">
            <div className="space-y-2 text-gray-300 dark:text-gray-400 text-sm">
